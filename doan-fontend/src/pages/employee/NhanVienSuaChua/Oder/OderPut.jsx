                  ...
                  <div className="row">
                    <div className="col-md-8">
                      ...
                      <div className="form-group">
                        ...
                        <input type="text" className="form-control" id="ky-su" />
                      </div>
                    </div>
                    ...
                    <div className="col-md-4">
                      <div className="form-group">
                        <label>Bộ Phận</label>
                        <input type="text" className="form-control" id="bo-phan" />
                      </div>
                      <div className="form-group">
                        <label>Số lượng Oder</label>
                        <input type="text" className="form-control" id="vi-tri" />
                      </div>
                      <div className="form-group">
